...
OUTPUT_VIDEO    = "track_result.mp4"        # 可视化输出视频
OUTPUT_CSV      = "food_temp_log.csv"       # 温度日志
...
# 分批处理参数（核心：避免 OOM）
CHUNK_SIZE      = 200     # 每批处理帧数，根据内存调整（越小越省内存）
# RTX 5070 Ti 16GB 显存 + 建议系统内存 ≥ 16GB：200 帧约占 6~8 GB
